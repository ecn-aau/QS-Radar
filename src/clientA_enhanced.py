...
def request_pqc_key() -> tuple[str, bytes]:
    with oqs.KeyEncapsulation(KEY_EXCHANGE_BACKUP) as client:
...
if __name__ == "__main__":
    logging.info(f"Starting QS-Radar: {SIGALG} + {KEY_EXCHANGE} (backup {KEY_EXCHANGE_BACKUP})")
    ...
    logging.info(f"Ending QS-Radar: {SIGALG} + {KEY_EXCHANGE} (backup {KEY_EXCHANGE_BACKUP})")